...
titleEn: battlepass_task_xp_multiplier
category: effects
subcategory: economy
tags:
  - libreforge
...
# battlepass_task_xp_multiplier <Badge type="info" text="libreforge" /> <Badge type="warning" text="永久型" />
...
| 属性 | 值 |
|------|-----|
| 类型 ID | `battlepass_task_xp_multiplier` |
| 所属模块 | libreforge |
| 分类 | 经济（Economy） |
| 效果类型 | 永久型 |
