...
|--------|------|------|--------|--------|------|
| `multiplier` | Expression(数学表达式) | ✅ | — | — | The multiplier \| Source: The damage multiplier applied on a critical hit. Supports expressions. Example: `1.5 + %level% * 0.05` |

## 📝 源码注记

> 以下信息来自 libreforge 源码（`libreforge/core/common/src/main/kotlin/com/willfp/libreforge/effects/impl/EffectCritMultiplier.kt`）。

- **源码描述**: Multiplies damage when the player lands a critical hit (falling attack).
- **所属分类**: `combat`
