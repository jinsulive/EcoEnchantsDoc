...
> Multiplies the player's movement efficiency while in water.
...
|-----------|------|----------|---------|---------|-------------|
| `multiplier` | Expression | ✅ | — | — | The multiplier to apply to water movement efficiency. Supports expressions. Example: `1 + %level% * 0.05` |
