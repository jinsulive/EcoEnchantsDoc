...
> Multiplies the player's gravity, making them fall faster or slower.
...
|-----------|------|----------|---------|---------|-------------|
| `multiplier` | Expression | ✅ | — | — | The gravity multiplier to apply. Supports expressions. Example: `1 - %level% * 0.05` |
