...
> Multiplies the player's movement speed while the holder is active.
...
|-----------|------|----------|---------|---------|-------------|
| `multiplier` | Expression | ✅ | — | — | The movement speed multiplier to apply (e.g. 1.5 = 50% faster). Supports expressions. Example: `1 + %level% * 0.05` |
